...
public class ORAQueryExecutor<Q extends IQueryObject> extends QueryExecutor<Q> {
	...
	// ORACLE doesn't support MySQL LIMIT syntax, so we skip the paginations
	// for now
	...
	try {
		...
		// 4 * 1024 * 1024 / sum(data_length for all columns of your
		// table) is a reasonable fetch size.
