...
/**
 * Executes a query {@link IQueryRetrieval} and reports the results via
 ...
 * @param <Output>
 */
public abstract class QueryReporter<T, Q extends IQueryRetrieval<T>, Output> extends
	QueryAbstractReporter<T, Q, Output> {
